                ...
                <div className="max-w-2xl">
                    <FadeIn>
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white leading-[1.1] mb-6">
                            Fleet Management System<p><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2F80FF] to-[#4DA3FF]">with Real-Time GPS Tracking France</span></p>
                        </h1>
